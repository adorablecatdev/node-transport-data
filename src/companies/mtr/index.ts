...
export async function run(): Promise<void> {
  console.log("[mtr] fetching lines and stations");
  ...
  console.log(
    `[mtr] wrote ${Object.keys(routesOut).length} routes and ${Object.keys(routeStopsOut).length} route-stop groups to ${OUT_DIR}/`,
  );
}
